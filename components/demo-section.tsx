      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/80 max-w-3xl mx-auto">
            Watch how easy it is to create professional applications with just a
            conversation.
          </p>
        </div>
            ...
            {[
              ...
              <Button
                ...
                className={`${
                  activeTab === id
                    ? "bg-white text-black"
                    : "border-white/30 text-white bg-white/50 hover:bg-white/10"
              ...
              <div className="p-8">
                <div className="space-y-4 max-h-96 overflow-y-auto">
                  ...
                  <div className="flex justify-end">
                    <div className="bg-white rounded-2xl px-4 py-3 max-w-md">
                      <p className="text-black">
                        I'll create a beautiful todo app with dark mode toggle.
                        Let me build the components, add task management
                        functionality, and implement a sleek dark theme.
                      </p>
                    </div>
                  </div>
                  <div className="flex justify-start">
                  ...
                  <div className="flex justify-end">
                    <div className="bg-white rounded-2xl px-4 py-3 max-w-md">
                      <p className="text-black">
                        Perfect! I'm adding secure user authentication with
                        login/signup forms, session management, and personalized
                        todo lists for each user.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-900 rounded-lg p-6 min-h-64 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-white/60 text-sm mt-2">
                      Click to see your app in action
                    </p>
                  </div>
                </div>
              </div>
